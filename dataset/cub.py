...
root = "dataset/data/cubbird/CUB_200_2011/CUB_200_2011"

def cub_loader(args):
    train_dataset = ImageLoader(root, transform = train_transform_v2, train = True)
    valid_dataset = ImageLoader(root, train = False, transform = test_transform)
